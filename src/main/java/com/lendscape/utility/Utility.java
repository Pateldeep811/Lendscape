package com.lendscape.utility;


import com.google.common.base.Function;
import com.lendscape.drivermanager.ManageDriver;
...
//********* ScreenShot Methods ****************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "src/main/java/com/lendscape/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "src/main/java/com/lendscape/screenshots/" + screenshotName + dateName + ".png";
    ...
    public void acceptCookiesAndSwitchToIframe() throws InterruptedException {
        ...
        Thread.sleep(1000);
        WebElement acceptCookies = driver.findElement(By.xpath(""));
        acceptCookies.click();
    }
